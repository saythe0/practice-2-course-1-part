...
var snowStorm = (function (window, document) {
	...
	this.className = 'snowMobileFoo' // CSS class name for further customization on snow elements
	this.excludeMobile = true // Snow is likely to be bad news for mobile phones' CPUs (and batteries.) By default, be nice.
	this.flakeBottom = null // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
	this.followMouse = true // Snow movement can respond to the user's mouse
	this.snowColor = '#777777' // Don't eat (or use?) yellow snow.
	this.snowCharacter = '•' // &bull; = bullet, &middot; is square on some systems etc.
	this.snowStick = true // Whether or not snow should "stick" at the bottom. When off, will never collect.
	this.targetElement = 'body' // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
